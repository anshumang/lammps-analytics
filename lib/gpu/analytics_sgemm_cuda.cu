...
#include "parboil.h"
#include <iostream>
#include "analytics_sgemm_cuda_kernel.cu"
...
int
sgemm_wrap_main (int argc, char *argv[]) {
  ...
  printf("params->inpFiles[0]=%s\n", params->inpFiles[0]);
  printf("params->inpFiles[1]=%s\n", params->inpFiles[1]);
  printf("params->inpFiles[2]=%s\n", params->inpFiles[2]);
  printf("params->inpFiles[3]=0x%x\n", params->inpFiles[3]);
